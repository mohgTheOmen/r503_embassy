...
// DISCLAIMER!
// I dont know how to read the fingerprint data, I just tested the ring light
...
async fn main(_spawner: Spawner) {
    ...
    let (uart, tx_pin, tx_dma, rx_pin, rx_dma) = (p.UART1, p.PIN_8, p.DMA_CH0, p.PIN_9, p.DMA_CH1);
